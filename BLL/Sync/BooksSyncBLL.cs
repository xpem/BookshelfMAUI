...
namespace BLL.Sync
{
    public class _BooksSyncBLL : _IBooksSyncBLL
    {
        ...
        //public _BooksSyncBLL(IBookHistoricLocalDAL bookHistoricLocalDAL, IBookHistoricApiBLL bookHistoricApiBLL,
        //    IBooksApiBLL booksApiBLL, IUserBLL userBLL, IUserLocalDAL userLocalDAL)
        //{
        ...
        //                List<Book> booksList = await LocalDbDAL.Books.BookLocalDAL.GetBooksByLastUpdate(user.Id, user.LastUpdate);
        ...
        //                            await LocalDbDAL.Books.BookLocalDAL.UpdateBookId(localTempId, Convert.ToString(addBookResp.Content), user.Id);
        //                        }
        //                        else throw new Exception($"Não foi possivel sincronizar o livro {book.Id}, res: {addBookResp.Error}");
        //                    }
        //                    else
        //                        await LocalDbDAL.Books.BookLocalDAL.UpdateBook(book, user.Id);
        //                }
        ...
        //                        {
        //                            await LocalDbDAL.Books.BookLocalDAL.AddOrUpdateBook(book, user.Id);
