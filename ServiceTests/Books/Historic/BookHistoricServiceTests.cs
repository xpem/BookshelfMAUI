...
namespace ServiceTests.Books.Historic
{
    [TestClass()]
    public class BookHistoricServiceTests
    {
        [TestMethod()]
        public void GetBookHistoricByBookIdTest()
        {
            ...
            BookHistoricService BookHistoricService = new(mockBH.Object);

            List<UIBookHistoric> result = BookHistoricService.GetByBookIdAsync(1, 1, 1).Result;
