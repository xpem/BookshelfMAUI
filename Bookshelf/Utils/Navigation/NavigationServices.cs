...
namespace Bookshelf.Utils.Navigation
{
    public class NavigationServices : INavigationServices
    {
        ...
        //private static ViewModelBase GetPageViewModelBase(Page p) => p?.BindingContext as ViewModelBase;
        ...
        //    bool isForwardNavigation = NavigationServices.Navigation.NavigationStack.Count > 1
        //        && NavigationServices.Navigation.NavigationStack[^2] == sender;
