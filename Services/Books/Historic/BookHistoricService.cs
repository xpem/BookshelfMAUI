...
{
    public class BookHistoricService(IBookHistoricRepo bookHistoricRepo) : IBookHistoricService
    {
        public async Task<List<UIBookHistoric>> GetByBookIdAsync(int uid, int page, int bookId)
        {
            List<UIBookHistoric> uIBookHistoricList = [];

            List<BookHistoric> list = await bookHistoricRepo.GetBookHistoricByBookIdAsync(uid, bookId, page);
        ...
        public async Task<List<UIBookHistoric>> GetAsync(int uid, int page)
        {
            ...
            try
            {
                List<BookHistoric> bookHistoricList = await bookHistoricRepo.Get(uid, page);
