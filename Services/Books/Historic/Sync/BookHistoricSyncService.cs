...
{
    public class BookHistoricSyncService(IBookHistoricApiServices bookHistoricApiBLL, IBookHistoricRepo bookHistoricRepo) : IBookHistoricSyncService
    {
        ...
        public async Task ApiToLocalSync(int uid, DateTime lastUpdate)
        {
            ...
            while (true)
            {
                Models.Responses.ServiceResponse respGetBookHistoricListByCreatedAt = await bookHistoricApiBLL.GetByLastCreatedAtAsync(lastUpdate, page);
                ...
                if (respGetBookHistoricListByCreatedAt.Success && respGetBookHistoricListByCreatedAt.Content is not null)
                {
                    ...
                    if (bookHistoricsList is not null)
                    {
                        ...
                        {
                            await bookHistoricRepo.ExecuteAddBookHistoricAsync(bookHistoric, uid);
                        }
